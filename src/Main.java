...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String input = "((A[20,10]|(B[20,10]|C[30,10]))-G[70,10])-((D[30,50]|(E[40,30]-F[40,20]))-H[70,20])";
        ...
        if(root.checkRec()){
            ...
            System.out.println(AssetFunctions.exportStringFromTree(tree));
            ...
            System.out.println(AssetFunctions.exportStringFromTree(rotatedTree));
